...
$(function() {
  $.getJSON('http://api.yelp.com/business_review_search?term='+term+'&lat=40.766&long=-73.990&radius=10&limit=10&ywsid=WRKYQtsZN-0vUyGouB9GlQ&callback=?', function(d) {
...
function markers(d) {
  ...
  $.each(d.businesses, function(i,item) {
    ...
    var Icon = L.Icon.extend({
      iconUrl: 'img/icons/ramen-24.png',
      shadowUrl: null,
...
function createMap(url, data) {
  ...
  .setView(new L.LatLng(40.766, -73.990), 16);
